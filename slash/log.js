...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    interaction.reply({
      content: `Created a channel ${logChannel} in this server!\nPlease don't edit the name of the channel else it won't work!\nIf you want to stop the giveaway log in that channel then edit the name or manually delete it!\nIf 2 channels were made delete the one where a message hasn't been sent by the bot!`,
      ephermal: true,
    });
  },
};
